...
function Profile({name, position, url}) {
    return (
            ...
            />
            <div className="profile-desc">{name}</div>
            <div className="profile-desc-pos">{position}</div>
            </div>
    );
}
    ...
    return (
        <section className="">
            ...
            src={members[7].imageURL}
             /> */}
             <h3>OUR TEAM</h3>
             <Profile name={"Niranjana"} position="President" url="https://media-exp1.licdn.com/dms/image/C5603AQFFHN19hsQj4A/profile-displayphoto-shrink_400_400/0/1618923833222?e=1640822400&v=beta&t=y6iz3G8SzkDW0QOHGAHfQ1cTXLZ1iQFOdvGc6G-3NqQ"/>
            ...
            <Profile name="Aswathy S Menon" position="Head of Content" url="https://media-exp1.licdn.com/dms/image/C5603AQEC9hbfip7_Xg/profile-displayphoto-shrink_400_400/0/1622300825651?e=1640822400&v=beta&t=2tW6P-SythxnhheE83SJWBwcnhNgCL6r8QLzpIvB4PA"/>
            <Profile name="Sangeeth S" position="Cheif Editor, Munner's Daily" url="https://media-exp1.licdn.com/dms/image/C4D03AQEqy3EdaiEtCA/profile-displayphoto-shrink_400_400/0/1594644535712?e=1640822400&v=beta&t=qVDWHI4Mnc3nCn6YL0gEodVWSQkvZgFIpCb_c3V9sOI"/> 
        </section>
    );
